...
// // // import {
// // //   filterFieldsMyProductsTab,
// // // } from "@/lib/filters/myProductsTabFilters";
...
// // //     )
// // //       .then((newData) => {
// // //         setMyProducts((prev) => [...prev, ...newData]);
...
// //   const { user } = useAuth();
// //   const navigate = useNavigate();
// //   const { loading, deleteProduct, fetchUserProducts } = useProducts();
...
// //     if (!user?.user_id) return;
// //     setLoadingNextPage(true);
// //     fetchUserProducts(user.user_id, NUM_PRODUCTS_IN_PAGE, page * NUM_PRODUCTS_IN_PAGE)
// //       .then((newData) => {
// //         setMyProducts((prev) => [...prev, ...newData]);
// //         if (newData.length < NUM_PRODUCTS_IN_PAGE) {
// //           setHasMore(false);
...
//     setLoadingNextPage(true);
//     setPage(0);
//     fetchUserProducts(user.user_id, NUM_PRODUCTS_IN_PAGE, 0)
//       .then((newData) => {

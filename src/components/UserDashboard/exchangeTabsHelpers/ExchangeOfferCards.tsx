...
export function ExchangeOfferCards({ request, onApprove, onReject }: Props) {
          ...
          return (
            <Card
              ...
              className={`p-4 cursor-pointer border-2 transition rounded-xl ${
                ((product.availability === "Exchange" || product.availability === "Pending") && request.status=== "Pending") ? "cursor-not-allowed border-gray-300 dark:border-gray-700 dark:text-black bg-gray-200" :

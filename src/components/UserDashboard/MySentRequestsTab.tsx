...
// //           type="sent"
// //           onEditClick={(id) => console.log("עריכה", id)}
// //           onDeleteClick={(id) => console.log("מחיקה", id)}
// //         />
// //       )}
...
// //   );
// // }
// // 📁 components/MySentRequestsTab.tsx
// import { useEffect, useState } from "react";
// import { useAuth } from "@/context/AuthContext";
// import { useExchangeRequest } from "@/hooks/useExchangeRequest";
// import { IExchangeRequest } from "@/types/exchangeRequest";
...
//   const { user } = useAuth();
//   const { getUserRequests } = useExchangeRequest();
//   const { updateExchangeRequestProposalOptions, cancelMyRequest } = useExchangeRequest();
//   const [requests, setRequests] = useState<IExchangeRequest[]>([]);
//   const [loading, setLoading] = useState(true);
//   const [currentPage, setCurrentPage] = useState(1);
//   const [modalImage, setModalImage] = useState<string | null>(null);
...
//     try {
//       await cancelMyRequest(id, user.user_id, user.name);

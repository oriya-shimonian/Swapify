...
// import ApproveExchangeDialog from "../dialogs/ApproveExchangeDialog";
...
//   const [requestToApprove, setRequestToApprove] = useState<IExchangeRequest | null>(null);
...
//           }}
//           onApprove={(chosen_product_id) => {
//             toast.success("הבקשה אושרה בהצלחה");
//             setApproveDialogOpen(false);
//             setRequestToApprove(null);
//             approveRequest(
//               requestToApprove.request_id,
//               chosen_product_id,
...
//   );
// }
// 📁 components/exchangeTabsHelpers/MyReceivedRequestsTab.tsx
import { useEffect, useState } from "react";
import { useAuth } from "@/context/AuthContext";
import { useExchangeRequest } from "@/hooks/useExchangeRequest";
import { IExchangeRequest } from "@/types/exchangeRequest";
